...
export default {
  title: 'Components/Editable/PESEL Field',
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Standard field for entering Polish PESEL number with automatic validation of format, checksum, and birth date.',
          layout: {
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field with checksum validation as ERROR (blocking). Invalid checksums will block form submission.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field with checksum validation as WARNING (non-blocking). Invalid checksums will show a warning hint but will NOT block form submission.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
...
export const RequireAdult: Story = {
  name: 'Require Adult (18 +) - Error Validation',
  play: playForm(async (context) => {
    const canvas = within(context.canvasElement);
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field with adult validation as ERROR (blocking). Entering a PESEL of a person under 18 will block form submission.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
...
export const RequireAdultWarning: Story = {
  name: 'Require Adult (18 +) - Warning Validation',
  play: playForm(async (context) => {
    const canvas = within(context.canvasElement);
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field with adult validation as WARNING (non-blocking). Entering a PESEL of a person under 18 will show a warning hint but will NOT block form submission.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'PESEL field marked as required. Leaving it empty will cause a validation error.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field supports PESEL numbers of people born after 2000 (month + 20). Example: a person born on 01.01.2000 has the month encoded as 21.',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        description: {
          content:
            'Field automatically removes all non-digit characters. Typing "44-051-401-458" will be automatically converted to "44051401458".',
          layout: {
            component: 'static-content',
            tag: 'span',
          },
