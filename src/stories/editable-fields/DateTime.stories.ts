...
export const DefaultValue: Story = {
  play: async (context) => {
    await expect(context.args.formModel).toEqual({ dateWithDefault: "2024-01-29T14:30:00.000+01:00" });
  },
  args: {
    formModel: {},
    schema: {
...
export const PickFromMenu: Story = {
  ...
  play: async (context) => {
    ...
    const menuButton = document.getElementsByClassName("v-btn v-btn--block v-theme--light v-btn--density-default v-btn--size-default v-btn--variant-text v-tab");
    ...
    await expect(context.args.formModel.simpleDateTimeFromPicker).toEqual("2025-05-01T11:56:00.000+02:00")
