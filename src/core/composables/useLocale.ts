    ...
    messages: {
      ...
      de: {
        ...
        schedulerGrid: {
          ...
          noteIndicator: 'Notiz',
          status: 'Status',
          notePlaceholder: 'z.B. 8-15, nach 13 Uhr',
          editSchedule: 'Dienstplan bearbeiten',
          previousData: 'Vorherige Daten',
          modifiedData: 'Geänderte Daten',
          noNote: 'Keine Notiz',
          statusLabels: {
            PRESENT: 'Im Büro',
            WFH: 'Homeoffice',
      ...
      ru: {
        ...
        schedulerGrid: {
          ...
          noteIndicator: 'Заметка',
          status: 'Статус',
          notePlaceholder: 'например, 8-15, после 13:00',
          editSchedule: 'Редактировать расписание',
          previousData: 'Предыдущие данные',
          modifiedData: 'Измененные данные',
          noNote: 'Нет заметки',
          statusLabels: {
            PRESENT: 'В офисе',
            WFH: 'Удаленно',
      ...
      es: {
        ...
        schedulerGrid: {
          ...
          noteIndicator: 'Nota',
          status: 'Estado',
          notePlaceholder: 'p. ej., 8-15, después de las 13:00',
          editSchedule: 'Editar horario',
          previousData: 'Datos anteriores',
          modifiedData: 'Datos modificados',
          noNote: 'Sin nota',
          statusLabels: {
            PRESENT: 'En oficina',
            WFH: 'Trabajo remoto',
      ...
      fr: {
        ...
        schedulerGrid: {
          ...
          noteIndicator: 'Note',
          status: 'Statut',
          notePlaceholder: 'ex. 8-15, après 13h',
          editSchedule: 'Modifier le planning',
          previousData: 'Données précédentes',
